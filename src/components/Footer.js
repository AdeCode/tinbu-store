...
function Footer() {
  return (
      <div className='flex flex-col pt-[64px] pb-8 lg:px-[100px] px-4 bg-[#F9FAFB]'>
        <div className='flex flex-col lg:flex-row justify-between lg:mb-24'>
        ...
        <div className='border-t border-[#E4E7EC] pt-8 flex flex-col lg:flex-row lg:items-center justify-between'>
          <div className='flex flex-col'>
