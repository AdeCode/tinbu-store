            ...
            <div className='flex flex-col lg:flex-row bg-white justify-between items-center lg:px-[100px] py-2 px-2 lg:py-5'>
                <div className='flex lg:gap-10 md:gap-24 gap-12  items-center'>
                    ...
                    <div className='flex justify-between items-center'>
                        <ul className='flex lg:h-full justify-between items-center text-primaryText font-medium lg:text-lg lg:gap-9 gap-4 mr-4'>
                            <li className='h-full'>
                    ...
                    <div className='flex justify-between items-center'>
                        <ul className='flex lg:h-full justify-between items-center text-primaryText font-medium lg:text-lg lg:gap-9 mr-4'>
                            ...
                            <li className='h-full relative'>
                                ...
                                <Link className='h-full flex flex-col gap-3' href='/cart'>
                                    <div className='flex justify-center'>
