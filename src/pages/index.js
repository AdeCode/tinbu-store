...
export default function Home() {
  return (
    <main
      className={`bg-[#F9FAFB] w-full px-[100px]`}
    >
      <div className="h-[500px] bg-bg-top w-full flex items-center px-16 bg-center bg-cover lg:mb-[91px]">
        <div className="">
          <span className="text-white font-semibold text-sm bg-[#1671D9] rounded-xl py-1 px-3 lg:mb-3">ENDLESS SUMMER SALE</span>
          <h1 className="lg:w-[464px] text-6xl font-medium text-white lg:mb-6">
