...
export default function Home() {
  return (
    ...
    >
      <div className="lg:h-[500px] h-[300px] bg-bg-top w-full flex lg:items-center lg:px-16 px-4 py-4 bg-center bg-cover lg:mb-[91px] mb-10">
        <div className="">
          ...
          <button className="bg-[#F56630] text-white flex w-[100px] lg:w-[141px] rounded-lg lg:h-[56px] h-[36px] items-center 
